...
function MenuPrintPage() {
  ...
  return (
    <section className="w-full px-4 py-8 sm:px-6 lg:px-8 print:px-4 print:py-4">
      <div className="mx-auto max-w-6xl space-y-10 flex flex-col gap-1 justify-center items-center">
        ...
        <div className="text-center text-xs sm:text-sm flex flex-col justify-center items-center text-neutral-700 h-[60vh] space-y-1 print-avoid-break">
