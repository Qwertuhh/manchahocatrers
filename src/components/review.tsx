...
const reviews: Review[] = [
  ...
  },
  {
    name: "Urwashi Jain",
    content:
      "I recently used Manchaho Catrers for my baby shower and they were absolutely fantastic. The food was delicious and the presentation was beautiful. The staff was also very friendly and helpful. I would highly recommend them.",
  },
  {
    name: "Anil Jain",
    content:
      "I was blown away by the quality of the food and service provided by Manchaho Catrers. They truly went above and beyond to make my event special. I would definitely use them again in the future.",
  },
  {
    name: "Anupam Jain",
    content:
      "I recently used Manchaho Catrers for my birthday party and they were amazing. The food was delicious and the staff was so friendly and attentive. The presentation of the food was also beautiful. I would highly recommend them.",
  },
];
...
function ReviewList() {
  ...
  return (
    <section className="py-16 px-4 md:px-8 bg-neutral-900 overflow-hidden relative isolate">
      ...
      <h2 className="raleway-bold tracking-[0.025em] relative z-10 text-4xl md:text-5xl font-extrabold text-center text-white mb-12 drop-shadow-md">
        What Our <span className="text-neutral-300">Customers</span> Say
      </h2>
